...
from typing import Any, Literal, Optional, Protocol, Self, overload
...
class Compound(Protocol):
    def getChildShapes(
        self, topoType: Literal["Solid", "Shell", "Edge", "Wire", "Vertex"]
    ) -> list["ShapeLike"]: ...
...
class ShapeLike(Protocol):
    ...
    def generalFuse(
        self, objsToCutWith: list[Self], fuzzy_value: float=0.0 
    ) -> tuple[Compound, list[list[Self]]]: ...
    def fuse(self, objsToAdd: list[Self] | Self) -> Self: ...
    def check(self) -> bool: ...
    ...
    def distToShape(
        self, shape: Self, tol: float = 1e-07
    ) -> tuple[float, list[tuple[Vector, Vector]], list[tuple]]: ...
    def isSeam(self, face: Self) -> bool: ...

    def reverse(self) -> None: ...
    def getElement(self, name: str) -> Self: ...
    def section(self, tool: Self, tolerance: float=0.0, approximation: bool=False) -> Self: ...
    @overload
    def tangentAt(self, param: float) -> Vector: ...
    @overload
...
class FeatureLike(Protocol):
    ...
    def check(self) -> bool: ...
    def addProperty(
        self, type: str, name: str, section: str, description: str
    ) -> None: ...
