...
#    point : Base.Vector
    @overload
    def dot(self, vector2: Self) -> float: ...
    @overload
    def dot(self, vector2: int | float) -> Self: ...
    @overload
    def __mul__(self, vector2: Self) -> float: ...
    @overload
    def __mul__(self, vector2: int | float) -> Self: ...
    @overload
    def __rmul__(self, vector2: Self) -> float: ...
    @overload
    def __rmul__(self, vector2: int | float) -> Self: ...
